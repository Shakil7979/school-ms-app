...
<template> 
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      ...
      >
            ...
            <div>
              ...
              <div>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    <!-- Email -->
                    <div>
                        <InputLabel for="email" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" value="Email" />
                        <TextInput
                        id="email"
                        type="email"
                        name="email"
                    ...
                    <!-- Password -->
                    <div>
                        <InputLabel for="password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" value="Password" />
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <Checkbox
                            ...
                            class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] border-gray-300 dark:border-gray-700"
                        />
                        Keep me logged in
                        </label>
                        <Link
        ...
        <div
          class="relative items-center hidden w-full h-full bg-brand-950 lg:grid lg:w-1/2"
        >
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <Link :href="route('dashboard')" class="block mb-4">
                <img class="w-[150px] " :src="authLogo" alt="Logo" />
              </Link>
              <p class="text-center text-gray-400 dark:text-white/60">
                Effortless School Management for a Smarter Future.
              </p>
            </div>
          </div>
        </div>
