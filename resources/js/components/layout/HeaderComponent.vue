...
const notifyDropdownOpen = ref(false)
...
const toggleNotifyDropdown = () => {
  notifyDropdownOpen.value = !notifyDropdownOpen.value
...
const closeDropdowns = () => {
  notifyDropdownOpen.value = false
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
      ...
      >
        <div class="2xsm:gap-3 flex items-center gap-2">
          <!-- Dark Mode Toggle -->
          <button
            class="relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500"
          ...
          <div class="relative" @click.stop>
            <button
              @click.prevent="toggleNotifyDropdown"
              class="relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500"
            >
              <span v-if="notifying" class="absolute top-0.5 right-0 z-1 h-2 w-2 rounded-full bg-orange-400">
